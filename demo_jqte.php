...
$(document).ready(function(){
	...
	$('.jqte_source').after('<div id="jqte_table" class="jqte_table" data-number="0">'+
								'<div class="table_box">'+
									'<div>'+
										'<div class="table_title">行 數</div>'+
										'<div><input class="table_row table_input" type="text" value="3" ></div>'+
									'</div>'+
									'<div class="table_spacing">'+
										'<div class="table_title">列 數</div>'+
										'<div><input class="table_column table_input" type="text" value="2" ></div>'+
									'</div>'+
								'</div>'+
								'<div class="table_box">'+
									'<div>'+
										'<div class="table_title">寬 度</div>'+
										'<div><input class="table_width table_input" type="text" value="500" ></div>'+
									'</div>'+
									'<div class="table_spacing">'+
										'<div class="table_title">高 度</div>'+
										'<div><input class="table_height table_input" type="text" value="300" ></div>'+
									'</div>'+
								'</div>'+
								'<div class="table_box">'+
									'<div>'+
										'<div class="table_title">間 距</div>'+
										'<div><input class="table_cellspacing table_input" type="text" value="1" ></div>'+
									'</div>'+
									'<div class="table_spacing">'+
										'<div class="table_title">內 距</div>'+
										'<div><input class="table_cellpadding table_input" type="text" value="1" ></div>'+
									'</div>'+
								'</div>'+
								'<div class="table_box">'+
									'<div>'+
										'<div class="table_title">邊 框</div>'+
										'<div><input class="talbe_border table_input" type="text" value="1" ><div>'+
									'</div>'+
								'</div>'+
								'<div class="cb"></div>'+
								'<div class="table_tool">'+
									'<div class="table_def">默認</div>'+
									'<div class="table_ins">插入</div>'+
									'<div class="cb"></div>'+
								'</div>'+
							'</div>');
	
	$('.jqte_source').after('<div class="jqte_massage"></div>');
	...
	$(document).on("dblclick", "#abcde", function() {
		console.log('123');
	});
	...
	$(document).on("click", "#setting_prompt", function() {
		$.each($('.prompt_box'), function(index) {
			var prompt_box = $('.prompt_box:eq('+index+')');
			
			if(prompt_box.css('position') == 'relative') { //判斷prompt_box是否有position:relative
				if(prompt_box.attr('data-open') == '' || prompt_box.attr('data-open') == undefined) {
					prompt_box.attr('data-open', 'on');
					
					var pb_width = prompt_box.outerWidth();
					var pb_height = prompt_box.outerHeight();
					
					prompt_box.append('<canvas class="prompt_spotlight" width="'+pb_width+'" height="'+pb_height+'" style="position:absolute; left:0px; top:0px; pointer-events: none; opacity: 0.75; z-index:999999;"></canvas>');
					
					var ctx = $('.prompt_box:eq('+index+') > .prompt_spotlight')[0].getContext('2d');
					ctx.beginPath();
					ctx.fillRect(0, 0, pb_width, pb_height);
					for(i=0; i<prompt_box.find('.prompt_highlight').length; i++) {
						var prompt_box_highlight = prompt_box.find('.prompt_highlight:eq('+i+')');
						
						var cR_left = prompt_box_highlight.offset().left - prompt_box.offset().left - 1;
						var cR_top = prompt_box_highlight.offset().top - prompt_box.offset().top -1;
						var cR_width = prompt_box_highlight.outerWidth() +2;
						var cR_height = prompt_box_highlight.outerHeight() +2;
						//console.log(cR_left+', '+cR_top+', '+cR_width+', '+cR_height);
						ctx.clearRect(cR_left, cR_top, cR_width, cR_height);
					}
					ctx.fill();
				}
				else {
					prompt_box.attr('data-open', '');
					$('.prompt_box:eq('+index+') > .prompt_spotlight').remove();
				}
			}
			else {
				console.log('prompt_box:eq('+index+') need css style "position:relative;"');
			}
		});
	});
...
<body>
<div id="setting_prompt" style="text-align: center; width: 200px;line-height: 45px; /* background-color: rgb(255, 50, 50); */border: 1px solid red;border-radius: 5px;overflow: hidden;background: linear-gradient(top,rgb(255, 129, 129),rgb(255, 50, 50)); background: -moz-linear-gradient(top, rgb(255, 129, 129),rgb(255, 50, 50)); background: -webkit-linear-gradient(top,rgb(255, 129, 129),rgb(255, 50, 50));">
  <div style="border-top: 1px solid rgba(255, 255, 255, 0.5); font-size: 12pt; color: #fff; border-radius: 5px;">提示</div>
</div>
<br />

<div style="width:516px; height:250px; background-color:lime; overflow-y:auto; float:left;">
	<div style="width:516px; height:40px; background-color:olive;">title</div>
	<div class="prompt_box" style="position:relative;">
		<div><div class="prompt_highlight" style="display:inline-block; width:100px; height:100px; background-color:red;"></div></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:grey;"></div>
		<span style="border: 5px solid red;"><div class="prompt_highlight" style="display:inline-block; width:100px; height:100px; background-color:purple;"></div></span>
		<div style="display:inline-block; width:100px; height:100px; background-color:pink;"></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:aqua;"></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:red;"></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:grey;"></div>
		<div class="prompt_highlight" style="display:inline-block; width:100px; height:100px; background-color:purple;"></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:pink;"></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:aqua;"></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:red;"></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:grey;"></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:purple;"></div>
		<div class="prompt_highlight" style="display:inline-block; width:100px; height:100px; background-color:pink;"></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:aqua;"></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:red;"></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:grey;"></div>
		<div class="prompt_highlight" style="display:inline-block; width:100px; height:100px; background-color:purple;"></div>
		...
		<div style="display:inline-block; width:100px; height:100px; background-color:purple;"></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:pink;"></div>
		<div class="prompt_highlight" style="display:inline-block; width:100px; height:100px; background-color:aqua;"></div>
	</div>
</div>
<div style="width:516px; height:250px; background-color:lime; overflow-y:auto; float:left; margin-left:20px;">
	<div style="width:516px; height:40px; background-color:olive;">title</div>
	<div class="prompt_box" style="position:relative;">
		<div><div class="prompt_highlight" style="display:inline-block; width:100px; height:100px; background-color:red;"></div></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:grey;"></div>
		...
		<div class="prompt_highlight" style="display:inline-block; width:100px; height:100px; background-color:pink;"></div>
		<div class="prompt_highlight" style="display:inline-block; width:100px; height:100px; background-color:aqua;"></div>
		<div class="prompt_highlight" style="display:inline-block; width:100px; height:100px; background-color:red;"></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:grey;"></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:purple;"></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:pink;"></div>
		<div style="display:inline-block; width:100px; height:100px; background-color:aqua;"></div>
...
<div style="width:1225px; height:528px; border-bottom:2px solid red;">
	<div style="float:left; width:206px; height:528px; background-color:#ffd0d0;">
		<div style="margin-top:193px; width:206px; height:252px;">
			<div style="position:absolute;"></div>
			<div style="position:absolute;"></div>
			<div style="position:relative;"></div>
		</div>
		<div id="abcde" style="position:relative; width:206px; height:83px;">
			<div style="position:absolute; left:0px; top:0px; width:103px; height:41px; background-color:rgba(255, 0, 0, 0.5); -webkit-user-modify:read-write;"></div>
			<div style="position:absolute; right:0px; top:0px; width:102px; height:41px; background-color:rgba(255, 0, 0, 0.5); -webkit-user-modify:read-write;"></div>
			<div style="position:absolute; left:0px; bottom:0px; width:103px; height:41px; background-color:rgba(255, 0, 0, 0.5); -webkit-user-modify:read-write;"></div>
			<div style="position:absolute; right:0px; bottom:0px; width:102px; height:41px; background-color:rgba(255, 0, 0, 0.5); -webkit-user-modify:read-write;"></div>
		</div>
	</div>
	<div style="float:left; width:1019px; height:528px;">
		<div style="border-bottom:3px solid red;">
			<div style="float:left; width:330px; height:32px; line-height:32px; -webkit-user-modify:read-write;"></div>
		...
		<div style="border-right:1px solid red;">
			<div style="float:left; width:660px; height:456px; margin:34px 0 3px 27px;">
				<?php for($i=0; $i<8; $i++) { ?>
			...
			<div style="float:left; width:302px; height:423px; margin:34px 27px 34px 0; border:1px solid red;">
				<div style="position:relative;">
						<div style="position:relative; width:302px; height:302px; border-bottom:1px solid red;"></div>
					...
					<div style="position:absolute; width:20px; height:40px; top:132px; left: 0px; background-color: red;"></div>
					<div style="position:absolute; width:20px; height:40px; top:132px; right: 0px; background-color: red;"></div>
				</div>
			</div>
			<div style="clear:both;"></div>
		</div>
